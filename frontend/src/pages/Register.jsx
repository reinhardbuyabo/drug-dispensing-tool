...
import { useSelector, useDispatch } from 'react-redux' // if you select sth from state, if we wanna ..
...
function Register() {
  ...
  const onSubmit = (e) => {
    ...
    if (password !== passwordConfirm) {
      ...
      dispatch(register(userData)); // to auathSlice.register ... passing it to the 'user' parameter
    }
  } 
