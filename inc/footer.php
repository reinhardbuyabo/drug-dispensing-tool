<footer class="footer">
    <div class="container">
        <a class="footer__logo" href="#">
            <img width="200" height="100" src="../assets/images/logo.png" />
        </a>
        ...
        <div class="footer__links col1">
            <a href="./register.php?user_type=patient">User Register</a>
            <a href="./register.php?user_type=admin">Admin Register</a>
            <a href="./register.php?user_type=pharmacist">Pharmacist Register</a>
        </div>

        <div class="footer__links col2">
            <a href="./login.php?user_type=patient">User Login</a>
            <a href="./login.php?user_type=doctor">Doctor Login</a>
            <a href="./login.php?user_type=pharmacist">Pharmacist Login</a>
            <a href="./login.php?user_type=admin">Admin Login</a>
        </div>
        ...
        <div class="footer__copyright">
            &copy;<?php echo date("Y"); ?> MedSource. All Rights Reserved.
        </div>
    </div>
